...
function AboutMe() {
    ...
    return (
        <div className="relative z-0 w-full p-4 text-justify flex flex-col bg-[var(--color-dark-slate)] text-[var(--text-color-secondary)] overflow-hidden min-h-screen">
            <div className="relative flex flex-col lg:grid lg:grid-cols-2 lg:gap-8 flex-grow min-h-full">
                ...
                <div className="pt-4 col-span-2 lg:text-[1.5rem] lg:h-1/2 xl:h-[60%] 2xl:h-[70%] 3xl:h-full   flex flex-col justify-between lg:flex-grow lg:self-baseline">
                    ...
                    <button
                        ...
                        className="flex items-center justify-center mt-8 max-w-[250px] lg:w-[320px] text-[12px] xs:text-[1rem] md:text-[1.2rem] lg:text-[1.5rem] bg-[--color-highlight] text-white rounded-lg py-3 px-6 shadow-lg hover:bg-[--color-highlight-dark] hover:scale-105 hover:shadow-xl transition-all duration-300 ease-in-out">
