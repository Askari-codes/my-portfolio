...
function TestimonialCard({ name, jobRole, image, testimonial }) {
  return (
    <div className="mt-6  p-6 text-justify rounded-lg shadow-lg md:p-8 md:mt-10 md:h-[290px] xl:h-[250px] 2xl:h-[220px] 3xl:h-[200px] 2xl:w-[600px] 3xl:min-w-[700px] bg-[--background-cards]  border-[1px] border-[--border-cards] md:transition-transform transform md:hover:scale-105">
