...
export const menuItemsData = [
  ...
  { label: "Portfolio", path: "#portfolio", isActive: false },
...
export const portfolioContent = {
  pageBackgroundTitle: "PORTFOLIO",
  issueTrackerProject: {
    title: "Issue Tracker",
    description:
      "  An advanced issue tracking tool built with Next.js and TypeScript that streamlines task management and enhances collaboration. This application offers full CRUD (Create, Read, Update, Delete) capabilities for managing issues efficiently. With integrated authentication, users can securely log in to track and manage issues. Key features include the ability to assign issues to specific users, ensuring accountability and facilitating team coordination.",
    github: { lable: "github", path: "issue-tracker" },
...
export const contactContect = {
  ...
  emailBoxTexts: {
    ...
    placeHolderTexts: {
      ...
      email: "Email",
      commentBox:
        "Have a question or an opportunity to discuss? Drop me a message...",
    },
  },
  addresses: [
    {
